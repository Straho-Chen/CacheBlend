...
from utils.utils import REPO_ROOT, load_dataset, build_fewshot_prompt_normal, compute_rl, extract_after_think, export_attention_matrices
...
llm = LLM(model=test_model, gpu_memory_utilization=0.75, dtype=torch.bfloat16, max_model_len=8192,
          #tokenizer=tokenizer,
          )
...
for sample_idx, ex in enumerate(eval_dataset):
    ...
    for i in range(len(doc_chunk_ids)):
        ...
        export_attention_matrices(cache_fuse_metadata, name_prefix=f"chunk{i}_")
